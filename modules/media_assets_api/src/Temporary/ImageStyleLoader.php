...
namespace Drupal\media_assets_api\Temporary;
 ...
 *
 * @package Drupal\media_assets_api\Temporary
 *
...
class ImageStyleLoader {
   ...
   *
   * @todo: Refactor. Original was \Drupal\media_assets\Render\AssetPreviewListMarkup;
   */

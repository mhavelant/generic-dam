...
namespace Drupal\media_statistics\Plugin\Block;
 ...
 * )
 *
 * @package Drupal\media_statistics\Plugin\Block
 */
...
EOD;
  ...
  public function build() {
    ...
    // @todo invalidate in media_statistics_file_download().
    $block[] = [
      '#cache' => [
        'max-age' => 0,
      ],
